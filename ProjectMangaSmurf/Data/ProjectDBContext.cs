    ...
    public class ProjectDBContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Avatar>(entity =>
            {
                ...
                entity.Property(e => e.IdAvatar).HasMaxLength(5).IsUnicode(false).IsFixedLength();
            ...
            modelBuilder.Entity<BoTruyen>(entity =>
            {
                ...
                entity.Property(e => e.IdBo).HasMaxLength(10).IsUnicode(false).IsFixedLength().HasColumnName("id_bo");
                entity.Property(e => e.Active).HasColumnName("active");
                entity.Property(e => e.AnhBanner).HasMaxLength(100).IsUnicode(false).HasColumnName("anh_banner");
                entity.Property(e => e.AnhBia).HasMaxLength(100).IsUnicode(false).HasColumnName("anh_bia");
                entity.Property(e => e.Dotuoi).HasColumnName("dotuoi");
                entity.Property(e => e.IdTg).HasMaxLength(6).IsUnicode(false).IsFixedLength().HasColumnName("id_tg");
                entity.Property(e => e.Listloai).HasColumnName("listloai");
                entity.Property(e => e.Mota).HasColumnName("mota");
                entity.Property(e => e.TenBo).HasMaxLength(30).HasColumnName("ten_bo");
            ...
            modelBuilder.Entity<Chapter>(entity =>
            {
                ...
                entity.Property(e => e.TenChap).HasMaxLength(30).HasColumnName("ten_chap");
            ...
            modelBuilder.Entity<CtBoTruyen>(entity =>
            {
                ...
                entity.Property(e => e.IdUser).HasMaxLength(10).IsUnicode(false).IsFixedLength();
                entity.Property(e => e.IbBo).HasMaxLength(10).IsUnicode(false).IsFixedLength().HasColumnName("ib_bo");
                entity.Property(e => e.DanhGia).HasColumnName("danh gia");
                entity.Property(e => e.LsMoi).HasMaxLength(10).IsUnicode(false).HasColumnName("ls_moi");
            ...
            modelBuilder.Entity<CtChapter>(entity =>
            {
                ...
                entity.Property(e => e.IdBo).HasMaxLength(10).IsUnicode(false).IsFixedLength().HasColumnName("id_bo");
                entity.Property(e => e.Active).HasColumnName("active");
                entity.Property(e => e.AnhTrang).HasMaxLength(80).IsUnicode(false).HasColumnName("anh_trang");
            ...
            modelBuilder.Entity<CtLoaiTruyen>(entity =>
            {
                ...
                entity.Property(e => e.IdLoai).HasMaxLength(5).IsUnicode(false).IsFixedLength().HasColumnName("id_loai");
                entity.Property(e => e.IdBo).HasMaxLength(10).IsUnicode(false).IsFixedLength().HasColumnName("id_bo");
                entity.Property(e => e.Active).HasColumnName("active");
            ...
            modelBuilder.Entity<LoaiTruyen>(entity =>
            {
                ...
                entity.Property(e => e.IdLoai).HasMaxLength(5).IsUnicode(false).IsFixedLength().HasColumnName("id_loai");
                entity.Property(e => e.Active).HasColumnName("active");
                entity.Property(e => e.TenLoai).HasMaxLength(30).HasColumnName("ten_loai");
            });

            modelBuilder.Entity<NhanVien>(entity =>
            {
                entity.HasKey(e => e.IdUser).HasName("PK_NhanVien");
                entity.Property(e => e.IdUser).HasMaxLength(10).IsUnicode(false).IsFixedLength().IsRequired();
                entity.Property(e => e.StaffRole).HasColumnName("StaffRole");

                entity.HasOne(d => d.IdUserNavigation).WithOne(p => p.NhanVien)
                    .HasForeignKey<NhanVien>(d => d.IdUser)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK_NhanVien_Users");

                entity.HasMany(e => e.StaffPermissionsDetails).WithOne(d => d.IdUserNavigation)
                    .HasForeignKey(d => d.IdUser)
            ...
            modelBuilder.Entity<Payment>(entity =>
            {
                ...
                entity.Property(e => e.IdPayment).HasMaxLength(10).IsUnicode(false).IsFixedLength();
                entity.Property(e => e.IdPack).HasMaxLength(4).IsUnicode(false).IsFixedLength();
                entity.Property(e => e.IdUser).HasMaxLength(10).IsUnicode(false).IsFixedLength();
            ...
            modelBuilder.Entity<ServicePackConfig>(entity =>
            {
                ...
                entity.Property(e => e.ParentPack).HasMaxLength(4).IsUnicode(false).IsFixedLength().HasColumnName("Parent_Pack");
            });
            ...
            modelBuilder.Entity<StaffActiveLog>(entity =>
            {
                ...
                entity.Property(e => e.IdLog).HasMaxLength(15).IsUnicode(false).IsFixedLength();
            ...
            modelBuilder.Entity<TacGium>(entity =>
            {
                ...
                entity.Property(e => e.IdTg).HasMaxLength(6).IsUnicode(false).IsFixedLength().HasColumnName("id_tg");
                entity.Property(e => e.Active).HasColumnName("active");
                entity.Property(e => e.TenTg).HasMaxLength(30).HasColumnName("ten_tg");
            });
            ...
            modelBuilder.Entity<User>(entity =>
            {
                ...
                entity.Property(e => e.Phone).HasMaxLength(10).IsUnicode(false).IsFixedLength();

                entity.HasOne(u => u.NhanVien)
                    .WithOne(nv => nv.IdUserNavigation)
                    .HasForeignKey<NhanVien>(nv => nv.IdUser)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK_User_NhanVien");

                entity.HasOne(u => u.KhachHang)
                    .WithOne(kh => kh.IdUserNavigation)
                    .HasForeignKey<KhachHang>(kh => kh.IdUser)
                    .OnDelete(DeleteBehavior.ClientSetNull)
